...
| **Recall on significant moves** | 74.8% (86/115) |
...
Orphans: `banking_nim_regime_low`, `cement_coal_shock`, `circular_debt_worsening_large`, `earnings_blackout_concentration`, `election_window_chop`, `fipi_capitulation`, `mf_accumulation_strong`, `mf_capitulation_with_value`, `mf_distribution_strong`, `mf_smart_money_divergence`, `phase1_cash_in_uptrend`, `pkr_devaluation_shock`, `volume_confirmation_breakout`
...
| **Playbook strategy cumulative return** | +143.8% |
| **Alpha (system - BH)** | +43.2% |
